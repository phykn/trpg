...
Reference for working under `client/`. End-user setup, phone testing, and deploy steps live in [README.md](./README.md). The server boundary contract lives in `../docs/plan.md`.
