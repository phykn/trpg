...
4. `screens/play/Playing.tsx` — game screen. Owns ephemeral UI state (`activeId`, `nearbyOpen`, `pendingAction`, BGM toggle, input draft). Uses graph confirmation state to decide whether a modal blocks input.
