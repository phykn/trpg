...
export const compose = {
  ...
  useItem: (name: string) => `${name}${josaObject(name)} 사용합니다`,
  equipItem: (name: string) => `${name}${josaObject(name)} 장비합니다`,
  unequipItem: (name: string) => `${name}${josaObject(name)} 해제합니다`,
