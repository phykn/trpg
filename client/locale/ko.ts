export const ko = {
  ...
  storyDev: {
    ...
    prompt: '프롬프트',
    preview: '미리보기',
    previewInput: '패치 미리보기 JSON',
    previewRun: '검증',
    previewOk: '통과',
    previewRejected: '거부',
    contractInput: '스토리 계약 JSON',
    contractRun: '계약 검증',
    contractApply: '계약 적용',
    contractOk: '계약 통과',
    contractRejected: '계약 거부',
    promptInput: '프롬프트 재현 JSON',
    promptRun: '프롬프트 재현',
    promptIntent: 'Intent',
    systemPrompt: 'System Prompt',
    userPayload: 'User Payload',
    defaultPromptReplayJson: '{"player_input":"주변을 살핍니다.","action":{"verb":"perceive","what":"surroundings"}}',
    rollback: '최근 패치 되돌리기',
    loading: '불러오는 중',
    noTimeline: '기록된 패치가 없습니다',
    noDebt: '미회수 항목이 없습니다',
    noGraph: '그래프를 불러오지 못했습니다',
    unresolvedClues: '미회수 단서',
    orphanCharacters: '위치 없는 인물',
    orphanItems: '위치 없는 물품',
    danglingQuestBeats: '열린 퀘스트 비트',
    gameId: 'Game ID',
    patchCount: 'Patch Count',
    lastPatch: 'Last Patch',
    rejectRate: 'Reject Rate',
    debtCount: 'Debt Count',
    graphSize: 'Graph Size',
    turn: (turn: number) => `T${turn}`,
    changed: (nodes: number, edges: number) => `노드 ${nodes} · 엣지 ${edges}`,
  },
  legend: {
    place: '장소',
    character: '캐릭터',
  ...
  error: {
    ...
    requestInterrupted: '요청이 끊겼습니다. 다시 시도해 주세요.',
  },
  shell: {
    loading: [
      '세계 펼치는 중',
