...
async def _run_classified_actions(
    ...
    *,
    ...
    actions, action_checks = _normalize_classified_action_sequence(actions, action_checks)
...
def _normalize_classified_action_sequence(
    actions: Sequence[Action],
    action_checks: Sequence[ActionCheckHint],
    ...
    while index < len(actions):
        ...
        check_hint = _check_hint_at(action_checks, index)
        ...
        while scan_index < len(actions):
            ...
            scan_check = _check_hint_at(action_checks, scan_index)
