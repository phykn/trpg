...
_ERROR_PHRASES_RAW: list[tuple[str, str]] = [
    ...
    ("weapon must go in the weapon slot", "무기는 무기 슬롯에만 장착할 수 있다"),
    ("defense item must go in armor or accessory slot", "방어 효과 물건은 갑옷이나 악세사리 슬롯에 장착할 수 있다"),
    ("decorative item must go in the accessory slot", "장식품은 악세사리 슬롯에만 장착할 수 있다"),
