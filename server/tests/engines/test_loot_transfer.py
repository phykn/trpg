...
from src.domain.entities import Character, Equipment
from src.engines.combat import transfer_loot_on_death
from src.engines.invariants import check_item_locality
...
def test_loot_transfer_leaves_state_locality_clean():
    ...
    from src.domain.entities import Item, Location, Race, Stats
