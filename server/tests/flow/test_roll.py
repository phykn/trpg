...
from src.flow.roll import _apply_movement_roll_outcome, run_roll
...
def test_bonus_breakdown_sum_matches_total_against_dc(fresh_state):
    ...
    from src.domain.memory import BonusItem, RollLogEntry
    from src.engines.combat import stat_modifier
    from src.rules.dc import compute_required_roll
